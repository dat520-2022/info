...
This course uses [QuickFeed](https://uis.itest.run/app/home), a tool developed at the University of Stavanger
...
4. You will then be invited to the course organization on GitHub and two separate repositories.
   ...
   - Navigate to the course organization [dat520-2022](https://github.com/dat520-2022) accept the invitation.
   - Navigate to the [assignments](https://github.com/dat520-2022/assignments) repository and accept the invitation.
   - Navigate to your private <https://github.com/dat520-2022/username-labs> repository and accept the invitation. Remember to replace `username` in this link with your own GitHub `username`.
...
5. Once you have accepted the invitations, you will get your own repository under `dat520-2022`, which is the course's organization on GitHub.
...
3. Once connected to the server, please register with our bot, `@dat520-helpbot`, by sending it a direct message:
   ...
   Hence, please make sure that you have joined the [`dat520-2022`](https://github.com/dat520-2022) GitHub organization and registered with QuickFeed first.
