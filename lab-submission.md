...
1. Initially, you will get access to two repositories when you have signed up on QuickFeed.
   ...
   The first is the [`assignments`](https://github.com/dat520-2022/assignments) repository, which is where we publish all lab assignments, skeleton code and additional information.
...
2. To get started, decide on a suitable location for your workspace for the course.
   In this guide we will use `$HOME/dat520-2022` as the workspace.
...
7. In summary, these are the typical steps that are necessary to make changes to
   ...
   ```console
   cd $HOME/dat520-2022/assignments/lab1
...
1. As time goes by the teaching staff may publish updates to the
   course [assignments](https://github.com/dat520-2022/assignments) repo,
...
We assume you have already created the `dat520-2022` directory on your machine.
